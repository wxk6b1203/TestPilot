...
func GenerateAPIWrappersSource(prep *lowCodeAPIPrep) (string, error) {
	...
	b.WriteString("# Regenerated from the latest API definitions on each dispatch; no edit needed when APIs change.\n")
	switch {
...
func GenerateAPIWrappersStub(prep *lowCodeAPIPrep) (string, error) {
	...
	b.WriteString("# For local code completion only; execution uses the tp_api_wrappers.py generated at dispatch time.\n")
