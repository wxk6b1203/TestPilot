...
感谢您对 **TestPilot** 的关注与贡献。请先阅读本指南，尤其是下方的**贡献者许可协议（CLA）**声明——本项目采用双重授权模式，该声明是法律前提。
...
> **重要**：本项目采用**双重授权**（AGPL-3.0 或商业授权）。授权方（wxk6b1203）需要将包括您贡献在内的全部代码以两种模式对外授权，因此以下条款是接受贡献的**必要前提**。
...
2. **授权范围**：您授予项目授权方一项**永久、不可撤销、非独占、全球范围、免版税**的许可，允许授权方：
   - 以 **AGPL-3.0** 条款使用、复制、修改、分发您的贡献及其衍生作品；
